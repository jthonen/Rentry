...
//         var searchItem = $(".prompt").val().trim();
//         var available = "";
//         var currentUser = "";

//         $.ajax({
//             url: "/api/items/" + searchItem,
//             type: "GET"
//         }).then(function(result) {
//             $(".ui.stackable.special.centered.cards").empty();
...
//                                 <div class="content">
//                                     <div class="center">
//                                         <div class="ui primary button learn-more" 
//                                             data-name="${result[i].name}" 
//                                             data-description="${result[i].description}"
//                                             data-quantity="${result[i].quantity}" 
//                                             data-category="${result[i].category}" 
